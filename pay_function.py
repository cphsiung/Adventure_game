...
# about error checking the user input unless you want to - you can assume
# the user types numbers properly. Do not name your variable sum or use
# the sum() function.
...
fhrs = float(hrs)
rates = input ("Enter regular pay rates:")
frates = float(rates)
p = computepay(fhrs,frates)
print("Pay",p)
